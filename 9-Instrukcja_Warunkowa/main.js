...
if (condition) {
  // alert("działa!");
  console.log(
    "widzisz mnie ponieważ warunek jest prawdziwy i wykonuje zawartość bloku instrukcji warunkowej"
  );
}
...
if (age <= 9 && typeof age === "number") {
  ...
  console.log(
    "Jesteś dojrzałem człowiekiem i doceniasz zalety tego wieku lub nie mogę ustalić twoejgo wieku"
  );
}
...
//   : console.log("wykonuje się bo warunek nie jest prawdziwy");
